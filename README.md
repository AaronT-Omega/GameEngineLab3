...
In the top left, you can click on buttons in order to either take damage, or set yourself on fire. You can toggle off the fire by pressing the button again.
